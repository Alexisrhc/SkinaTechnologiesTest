            ...
            <form id="sign_in" method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group">
                    ...
                    <div class="form-line">
                        ...
                        <select name="role" class="form-control @error('rome') is-invalid @enderror" id="role">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <button class="btn btn-block bg-pink waves-effect" type="submit">{{ __('Register') }}</button>
                    </div>
                </div>
            </form>
        </div>
